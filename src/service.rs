...
//! Source: `Interface '/org/freedesktop/systemd1/unit/pipewire_2eservice' from service 'org.freedesktop.systemd1' on system bus`.
//!
...
#[proxy(
    ...
    default_path = "/org/freedesktop/systemd1/unit/pipewire_2eservice"
)]
pub trait Service {
    ...
    /// EffectiveMemoryHigh property
    #[zbus(property)]
    fn effective_memory_high(&self) -> zbus::Result<u64>;

    /// EffectiveMemoryMax property
    #[zbus(property)]
    fn effective_memory_max(&self) -> zbus::Result<u64>;

    /// EffectiveMemoryNodes property
    #[zbus(property)]
    fn effective_memory_nodes(&self) -> zbus::Result<Vec<u8>>;

    /// EffectiveTasksMax property
    #[zbus(property)]
    fn effective_tasks_max(&self) -> zbus::Result<u64>;
    ...
    /// ExecMainHandoffTimestamp property
    #[zbus(property)]
    fn exec_main_handoff_timestamp(&self) -> zbus::Result<u64>;

    /// ExecMainHandoffTimestampMonotonic property
    #[zbus(property)]
    fn exec_main_handoff_timestamp_monotonic(&self) -> zbus::Result<u64>;
    ...
    /// MemoryZSwapWriteback property
    #[zbus(property, name = "MemoryZSwapWriteback")]
    fn memory_zswap_writeback(&self) -> zbus::Result<bool>;
